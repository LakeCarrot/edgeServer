...
public final class OffloadingGrpc {
        ...
        if ((getStartServiceMethod = OffloadingGrpc.getStartServiceMethod) == null) {
          OffloadingGrpc.getStartServiceMethod = getStartServiceMethod = 
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ...
                  .setSchemaDescriptor(new OffloadingMethodDescriptorSupplier("startService"))
                  .build();
          }
        }
     }
  ...
  private static abstract class OffloadingBaseDescriptorSupplier
      implements io.grpc.protobuf.ProtoFileDescriptorSupplier, io.grpc.protobuf.ProtoServiceDescriptorSupplier {
    OffloadingBaseDescriptorSupplier() {}

    @java.lang.Override
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return edgeOffloading.OffloadingOuterClass.getDescriptor();
    }

    @java.lang.Override
    public com.google.protobuf.Descriptors.ServiceDescriptor getServiceDescriptor() {
      return getFileDescriptor().findServiceByName("Offloading");
    }
  }

  private static final class OffloadingFileDescriptorSupplier
      extends OffloadingBaseDescriptorSupplier {
    OffloadingFileDescriptorSupplier() {}
  }

  private static final class OffloadingMethodDescriptorSupplier
      extends OffloadingBaseDescriptorSupplier
      implements io.grpc.protobuf.ProtoMethodDescriptorSupplier {
    private final String methodName;

    OffloadingMethodDescriptorSupplier(String methodName) {
      ...
      synchronized (OffloadingGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              .setSchemaDescriptor(new OffloadingFileDescriptorSupplier())
